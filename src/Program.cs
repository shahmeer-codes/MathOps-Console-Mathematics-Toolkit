            ...
            switch (choice)
            {
                ...
                case 2:
                    ...
                    if (sqrtNumber < 0)
                        ...
                        Console.WriteLine($"\nResult: {MathOperations.SquareRoot(sqrtNumber)}");
                ...
                case 3:
                    ...
                    {
                        case 1:
                            Console.WriteLine($"\nMinimum: {MathOperations.Minimum(first, second)}");
                            break;

                        case 2:
                            Console.WriteLine($"\nMaximum: {MathOperations.Maximum(first, second)}");
                            break;
                ...
                case 4:
                    ...
                    Console.WriteLine($"\nResult: {MathOperations.Power(baseNumber, exponent)}");
                ...
                case 5:
                    ...
                    Console.WriteLine($"\nResult: {MathOperations.Absolute(absoluteNumber)}");
                ...
                case 6:
                    ...
                    if (divisor == 0)
                        ...
                        Console.WriteLine($"\nRemainder: {MathOperations.Remainder(dividend, divisor)}");
                ...
                case 7:
                    ...
                    Console.WriteLine($"\nResult: {MathOperations.Round(roundNumber, decimals)}");
                ...
                case 8:
                    ...
                    Console.WriteLine($"\nResult: {MathOperations.Ceiling(ceilingNumber)}");
                ...
                case 9:
                    ...
                    Console.WriteLine($"\nResult: {MathOperations.Floor(floorNumber)}");
                ...
                case 10:
                    ...
                    {
                        case 1:
                            Console.WriteLine($"\nSine: {MathOperations.Sine(degrees)}");
                            break;

                        case 2:
                            Console.WriteLine($"\nCosine: {MathOperations.Cosine(degrees)}");
                            break;

                        case 3:
                            Console.WriteLine($"\nTangent: {MathOperations.Tangent(degrees)}");
                            break;
                ...
                case 11:
                    ...
                    else
                    {
                        ...
                        {
                            case 1:
                                Console.WriteLine($"\nResult: {MathOperations.NaturalLog(logNumber)}");
                                break;

                            case 2:
                                Console.WriteLine($"\nResult: {MathOperations.Log10(logNumber)}");
                                break;
